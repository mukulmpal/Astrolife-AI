    ...
    <>
      <style>{`
        ...
        *,*::before,*::after{margin:0;padding:0;box-sizing:border-box}
        ...
        .agent-status{font-size:11px;color:#1d9e75;display:flex;align-items:center;gap:4px;margin-top:2px}
        ...
        .send-btn{width:38px;height:38px;border-radius:10px;background:linear-gradient(135deg,#c8a030,#3c2880);border:none;cursor:pointer;display:flex;align-items:center;justify-content:center;font-size:16px;transition:all 0.2s;flex-shrink:0;color:#060410;font-weight:700}
      ...
      <div className="chat-layout">
        ...
        <div className="chat-main">
          ...
          <div className="chat-header">
            ...
            <div>
              <div className="agent-label">{activeAgent.name}</div>
