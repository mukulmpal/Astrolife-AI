...
function getMockSupportedPromise(rule: KPEventRule): KPEventPromiseResult {
  return {
    ...
    starLord: "Saturn",
    subLord: "Venus",
    subLordSignifications: rule.supportingHouses,
    subLordGrade: "GRADE_1",
    matchedSupportingHouses: rule.supportingHouses,
    matchedFacilitatingHouses: [],
    matchedDetrimentHouses: [],
    matchedBarrierHouses: [],
    evidenceDetails: [],
...
test("2I-E-B — Test F: Existing Cusp Promise Denial Produces PROMISE_DENIED", () => {
  ...
  const deniedPromise: KPEventPromiseResult = {
    ...
    starLord: "Saturn",
    subLord: "Mercury",
    subLordSignifications: [1, 6, 10],
    subLordGrade: "GRADE_2",
    matchedSupportingHouses: [],
    matchedFacilitatingHouses: [],
    matchedDetrimentHouses: [1, 6],
    matchedBarrierHouses: [10],
    evidenceDetails: [],
...
test("2I-E-B — Test: Strict Reference_Pending Guard Produces EVALUATION_PENDING", () => {
  ...
  const promise: KPEventPromiseResult = {
    ...
    starLord: "Ketu",
    subLord: "Venus",
    subLordSignifications: [2, 5, 11],
    subLordGrade: "GRADE_1",
    matchedSupportingHouses: [2, 5, 11],
    matchedFacilitatingHouses: [],
    matchedDetrimentHouses: [],
    matchedBarrierHouses: [],
    evidenceDetails: [],
