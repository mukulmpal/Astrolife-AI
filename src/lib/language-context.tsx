...
const TRANSLATIONS: Record<string, Record<Language, string>> = {
  ...
  "milan.page_title": { english: "Kundali Milan", hindi: "कुंडली मिलान", hinglish: "Kundali Milan" },
  "milan.page_sub": { english: "Beyond 36 Gunas: Ashtakoot, Manglik balance, Navamsha, psychology and shared timing.", hindi: "36 गुण से आगे: अष्टकूट, मांगलिक संतुलन, नवांश, मनोविज्ञान और साझा समय।", hinglish: "36 Gunas se aage: Ashtakoot, Manglik balance, Navamsha, psychology aur shared timing." },
  ...
  "milan.tab_children": { english: "Family Indicators", hindi: "परिवार संकेत", hinglish: "Family Indicators" },
  "milan.tab_kp": { english: "Marriage Potential", hindi: "विवाह योग", hinglish: "Marriage Potential" },
  "milan.tab_timing": { english: "Timing", hindi: "समय", hinglish: "Timing" },
  "milan.tab_doshas": { english: "Doshas & Remedies", hindi: "दोष और उपाय", hinglish: "Doshas & Remedies" },
  ...
  "milan.children_awareness": { english: "Family & Children Indicators", hindi: "परिवार और संतान संकेत", hinglish: "Family & Children Indicators" },
